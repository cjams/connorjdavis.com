...
formula does exist in the space of all mathematical functions. And neural networks and the training process in particualr give us a way to
...
we can grasp the basics with much simpler functions. The principles used here apply equally to all 
of them.
